...
class ServiceController extends Controller
{
    ...
    public function update(Request $request, int $id)
    {
        ...
        if (!$service) {
            return ResponseHelper::setError('service not found', ResponseStatusCodes::$error_status_code);
        }
        // Tell the validator that this file should be an image
        $rules = array(
            'name' => 'nullable|unique:services,name,' . $id,
            'description' => 'nullable',
            'category_id' => 'nullable',
            "images"    => "nullable|array|min:1|max:4",
            'images.*' => 'nullable|mimes:jpg,bmp,png,jpeg,gif|max:2048',
        );
