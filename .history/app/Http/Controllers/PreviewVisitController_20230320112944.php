...
use App\Http\Resources\PreviewVisitResource;
...
class PreviewVisitController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($previewVisits->isNotEmpty()) {
            ...
            return  ResponseHelper::setResponse('success',PreviewVisitResource::collection(User::all()) new PreviewVisitResource($previewVisits));
        } else {
    ...
    public function store(Request $request)
    {
        ...
        if ($previewVisit) {
            return  ResponseHelper::setResponse('success', new PreviewVisitResource($previewVisit));
        } else {
    ...
    public function update(Request $request, int $id)
    {
        ...
        if ($previewVisit) {
            return  ResponseHelper::setResponse('updated successfully', new PreviewVisitResource($previewVisit));
        } else {
            return ResponseHelper::setError('some thing went wrong', ResponseStatusCodes::$error_status_code, null);
        }
    }
