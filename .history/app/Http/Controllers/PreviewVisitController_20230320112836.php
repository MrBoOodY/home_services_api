...
class PreviewVisitController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($previewVisits->isNotEmpty()) {
            ...
            return  ResponseHelper::setResponse('success', new PreviewVisitResource($previewVisits));
        } else {
    ...
    public function update(Request $request, int $id)
    {
        ...
        if ($previewVisit) {
            return  ResponseHelper::setResponse('updated successfully', new PreviewVisitResource($previewVisits));
        } else {
            return ResponseHelper::setError('some thing went wrong', ResponseStatusCodes::$error_status_code, null);
        }
    }
