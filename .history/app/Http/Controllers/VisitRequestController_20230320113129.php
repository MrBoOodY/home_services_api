...
class VisitRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($visitRequests) {
            return ResponseHelper::setResponse('success', VisitRequestResource::collection($visitRequests));
        } else {
    ...
    public function store(Request $request)
    {
        ...
        if ($visitRequest) {
            return  ResponseHelper::setResponse('updated successfully', new VisitRequestResource($visitRequest));
        } else {
    ...
    public function update(Request $request, int $id)
    {
        ...
        if ($visitRequest) {
            return  ResponseHelper::setResponse('updated successfully',  new VisitRequestResource($visi3tRequest));
        } else {
            return ResponseHelper::setError('some thing went wrong', ResponseStatusCodes::$error_status_code, null);
        }
    }
